    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10 w-full">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-8 tracking-tight font-heading" style={{ color: '#F0F9FF', textShadow: '0 2px 20px rgba(0,0,0,0.35)' }}>
              Security &{' '}
              <span style={{
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 tracking-tight">Comprehensive Protection</h2>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {dataProtectionPractices.map((practice, index) => (
                  <div key={index} className="flex items-center gap-4 p-5 bg-white rounded-[1.5rem] shadow-sm border border-slate-100 group hover:border-emerald-200 hover:shadow-ambient transition-all">
              ...
              >
                <Card className={`bg-white rounded-[2.5rem] border border-slate-200 shadow-sm hover:shadow-2xl hover:shadow-blue-500/15 hover:-translate-y-2 h-full overflow-hidden transition-all duration-500 group relative`}>
                  ...
                  <CardHeader className="bg-slate-50 border-b border-slate-100 p-8 lg:p-10 relative">
                    ...
                    <CardTitle className="flex items-center gap-4 text-slate-900 font-black text-2xl tracking-tight relative z-10">
                  ...
                  <CardContent className="p-8 lg:p-10 pt-8">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-[#F8FAFC] overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <Card className="bg-white relative rounded-[3rem] border border-slate-200 shadow-ambient-lg overflow-hidden">
                ...
                <CardContent className="p-10 lg:p-12 pt-0 space-y-6 relative z-10">
                  {[
                    ...
                    <div key={i} className="p-6 bg-slate-50 rounded-[1.5rem] border border-slate-100 group hover:bg-white hover:border-blue-200 hover:shadow-ambient transition-all duration-300">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 tracking-tight">Institutional Trust</h2>
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-[#0F172A] text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-black mb-8 tracking-tight">Resilience Guaranteed</h2>
